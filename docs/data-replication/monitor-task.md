...
- **Full Sync Progress**: Shows the percentage of tables that have completed full synchronization. Open the node details to view the number of completed tables and the total number of tables.
